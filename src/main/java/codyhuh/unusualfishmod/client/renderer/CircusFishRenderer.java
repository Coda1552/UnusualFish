...
import codyhuh.unusualfishmod.common.entity.ambient.predator.CircusFish;
...
public class CircusFishRenderer extends MobRenderer<CircusFish, CircusFishModel<CircusFish>> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation(UnusualFishMod.MOD_ID, "textures/entity/circusfish.png");

    public CircusFishRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new CircusFishModel<>(renderManagerIn.bakeLayer(UFModelLayers.CIRCUS_FISH)), 0.25F);
    }
