...
import codyhuh.unusualfishmod.client.old.model.DualityDamselfishModel;
...
public class DualityDamselfishRenderer extends MobRenderer<DualityDamselfish, DualityDamselfishModel<DualityDamselfish>> {
	protected static final ResourceLocation TEXTURE = new ResourceLocation(UnusualFishMod.MOD_ID, "textures/entity/duality_damselfish_1.png");
