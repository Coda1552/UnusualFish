...
import codyhuh.unusualfishmod.client.old.model.BlindSailfinModel;
...
public class BlindSailfinRenderer extends MobRenderer<BlindSailfin, BlindSailfinModel<BlindSailfin>> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation(UnusualFishMod.MOD_ID, "textures/entity/blindsailfin.png");

    public BlindSailfinRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new BlindSailfinModel<>(renderManagerIn.bakeLayer(UFModelLayers.BLIND_SAILFIN)), 0.2F);
    }
