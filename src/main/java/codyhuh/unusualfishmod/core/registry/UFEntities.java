...
public class UFEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<FrostyFinFish>> FROSTY_FIN = ENTITIES.register("frostyfin", () -> EntityType.Builder.of(FrostyFinFish::new, MobCategory.WATER_AMBIENT).sized(0.4f, 0.4f).build("frostyfin"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<FallingTreeBlockEntity>> FALLING_TREE = ENTITIES.register("falling_tree", () -> EntityType.Builder.of(FallingTreeBlockEntity::new, MobCategory.MISC).sized(0.99F, 0.99F).setUpdateInterval(1).setShouldReceiveVelocityUpdates(true).updateInterval(10).clientTrackingRange(20).build("falling_tree"));
}
