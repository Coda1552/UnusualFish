...
public final class UFItems {
	...
	public static final RegistryObject<Item> ROOTBALL_BUCKET = ITEMS.register("rootball_bucket", () -> new UFFishBucketItem(UFEntities.ROOTBALL, () -> Fluids.WATER, Items.BUCKET, false, new Item.Properties().tab(UnusualFishMod.TAB).stacksTo(1)));
