...
public class PorcupineLobster extends BucketableWaterAnimal implements GeoEntity {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 4.0D).add(Attributes.MOVEMENT_SPEED, 0.5F).add(Attributes.ARMOR, 7.0F).add(Attributes.ATTACK_DAMAGE, 3.0F);
    }
