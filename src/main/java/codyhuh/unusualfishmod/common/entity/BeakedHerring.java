...
public class BeakedHerring extends BucketableSchoolingWaterAnimal implements GeoEntity {
	private boolean isSchool = true;

	public BeakedHerring(EntityType<? extends BucketableSchoolingWaterAnimal> entityType, Level level) {
	...
	public static boolean canSpawn(EntityType<BeakedHerring> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, RandomSource random) {
