...
public class Mossthorn extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(Mossthorn.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public Mossthorn(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(UFItems.MOSSTHORN_BUCKET.get());
	}
