...
public class Picklefish extends WaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(Picklefish.class, EntityDataSerializers.BOOLEAN);

	public Picklefish(EntityType<? extends WaterAnimal> entityType, Level level) {
