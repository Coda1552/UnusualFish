...
public class DualityDamselfish extends SchoolingWaterAnimal implements Bucketable {
	...
	public DualityDamselfish(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(UnusualFishItems.DUALITY_DAMSELFISH_BUCKET.get());
	}
