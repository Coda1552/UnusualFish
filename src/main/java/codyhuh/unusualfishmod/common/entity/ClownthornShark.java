...
public class ClownthornShark extends WaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(ClownthornShark.class, EntityDataSerializers.BOOLEAN);

	public ClownthornShark(EntityType<? extends WaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(UFItems.CLOWNTHORN_SHARK_BUCKET.get());
	}
