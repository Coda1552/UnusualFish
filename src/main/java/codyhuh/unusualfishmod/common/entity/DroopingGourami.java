...
public class DroopingGourami extends BucketableSchoolingWaterAnimal implements GeoEntity {

	public DroopingGourami(EntityType<? extends BucketableSchoolingWaterAnimal> entityType, Level level) {
