...
//REMOVE TILT FROM
public class SailorBarb extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(SailorBarb.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public SailorBarb(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(UnusualFishItems.SAILOR_BARB_BUCKET.get());
	}

	public static <T extends Mob> boolean canSpawn(EntityType<SailorBarb> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, Random p_223364_4_) {
		return WaterAnimal.checkSurfaceWaterAnimalSpawnRules(p_223364_0_, p_223364_1_, reason, p_223364_3_, p_223364_4_);
	}

	public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
		return UnusualFishEntities.rollSpawn(UnusualFishConfig.sailorBarbSpawnRolls, this.getRandom(), spawnReasonIn);
	}
