...
//REMOVE TILT FROM
public class SneepSnorp extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(SneepSnorp.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public SneepSnorp(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public static <T extends Mob> boolean canSpawn(EntityType<SneepSnorp> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, Random p_223364_4_) {
		return WaterAnimal.checkSurfaceWaterAnimalSpawnRules(p_223364_0_, p_223364_1_, reason, p_223364_3_, p_223364_4_);
	}

	public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
		return UnusualFishEntities.rollSpawn(UnusualFishConfig.bumpfaceSpawnRolls, this.getRandom(), spawnReasonIn);
	}
