package com.peeko32213.unusualfishmod.common.entity.msc;
...
public class AbyssalShot extends Entity {

    private UUID ownerUUID;
    private int ownerNetworkId;
    private boolean leftOwner;

    public AbyssalShot(EntityType entityType, Level level) {
        super(entityType, level);
    }

    public AbyssalShot(Level worldIn, LivingEntity p_i47273_2_, boolean right) {
        this(UnusualFishEntities.ABYSSAL_SHOT.get(), worldIn);
    ...
    @OnlyIn(Dist.CLIENT)
    public AbyssalShot(Level worldIn, double x, double y, double z, double p_i47274_8_, double p_i47274_10_, double p_i47274_12_) {
        this(UnusualFishEntities.ABYSSAL_SHOT.get(), worldIn);
        this.setPos(x, y, z);
        this.setDeltaMovement(p_i47274_8_, p_i47274_10_, p_i47274_12_);
    }

    public AbyssalShot(PlayMessages.SpawnEntity spawnEntity, Level world) {
        this(UnusualFishEntities.ABYSSAL_SHOT.get(), world);
    }
