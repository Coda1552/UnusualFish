...
public class BrickSnail extends WaterAnimal implements Bucketable {
    ...
    public BrickSnail(EntityType<? extends BrickSnail> type, Level world) {
        super(type, world);
        this.moveControl = new BrickSnail.MoveHelperController(this);
        this.maxUpStep = 1.0f;
    }
    ...
    public static <T extends Mob> boolean canSpawn(EntityType<BrickSnail> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, Random p_223364_4_) {
        return WaterAnimal.checkSurfaceWaterAnimalSpawnRules(p_223364_0_, p_223364_1_, reason, p_223364_3_, p_223364_4_);
    }

    public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
        return UnusualFishEntities.rollSpawn(UnusualFishConfig.brickSnailSpawnRolls, this.getRandom(), spawnReasonIn);
    }
