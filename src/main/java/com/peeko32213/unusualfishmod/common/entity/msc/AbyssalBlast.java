...
public class AbyssalBlast extends Entity  {
    ...
    public AbyssalBlast(Level worldIn, Gnasher p_i47273_2_) {
        this(UnusualFishEntities.ABYSSAL_BLAST.get(), worldIn);
    ...
    @OnlyIn(Dist.CLIENT)
    public AbyssalBlast(Level worldIn, double x, double y, double z, double p_i47274_8_, double p_i47274_10_, double p_i47274_12_) {
        this(UnusualFishEntities.ABYSSAL_BLAST.get(), worldIn);
        this.setPos(x, y, z);
    ...
    public AbyssalBlast(PlayMessages.SpawnEntity spawnEntity, Level world) {
        this(UnusualFishEntities.ABYSSAL_BLAST.get(), world);
    }
    ...
    protected void onEntityHit(EntityHitResult p_213868_1_) {
        ...
        boolean flag = entity.hurt(DamageSource.indirectMobAttack(this, livingentity).setProjectile(), 5.0F);
    }
