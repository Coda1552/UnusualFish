...
//REMOVE TILT FROM
public class Cometfish extends WaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(Cometfish.class, EntityDataSerializers.BOOLEAN);

	public Cometfish(EntityType<? extends WaterAnimal> entityType, Level level) {
	...
	public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
		return UnusualFishEntities.rollSpawn(UnusualFishConfig.gravelFlounderSpawnRolls, this.getRandom(), spawnReasonIn);
	}
