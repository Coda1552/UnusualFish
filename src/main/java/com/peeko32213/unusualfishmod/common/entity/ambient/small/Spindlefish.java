...
//REMOVE TILT FROM
public class Spindlefish extends WaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(Spindlefish.class, EntityDataSerializers.BOOLEAN);
	protected int attackCooldown = 0;

	public Spindlefish(EntityType<? extends WaterAnimal> entityType, Level level) {
	...
	public static <T extends Mob> boolean canSpawn(EntityType<Spindlefish> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, Random p_223364_4_) {
		return WaterAnimal.checkSurfaceWaterAnimalSpawnRules(p_223364_0_, p_223364_1_, reason, p_223364_3_, p_223364_4_);
	}

	public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
		return UnusualFishEntities.rollSpawn(UnusualFishConfig.spindleFishSpawnRolls, this.getRandom(), spawnReasonIn);
	}
