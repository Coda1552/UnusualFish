...
public class PorcupineLobster extends WaterAnimal implements Bucketable {
    ...
    protected void playStepSound(BlockPos p_33804_, BlockState p_33805_) {
        this.playSound(UnusualFishSounds.CRAB_CHATTER, 0.15F, 1.0F);
    }
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(UnusualFishItems.PORCUPINE_BUCKET.get());
    ...
    public static <T extends Mob> boolean canSpawn(EntityType<PorcupineLobster> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, Random p_223364_4_) {
        return WaterAnimal.checkSurfaceWaterAnimalSpawnRules(p_223364_0_, p_223364_1_, reason, p_223364_3_, p_223364_4_);
    }

    public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
        return UnusualFishEntities.rollSpawn(UnusualFishConfig.porcupineLobsterSpawnRolls, this.getRandom(), spawnReasonIn);
    }
