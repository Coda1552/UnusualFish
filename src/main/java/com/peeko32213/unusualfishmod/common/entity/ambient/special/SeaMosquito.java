...
public class SeaMosquito extends WaterAnimal implements Bucketable {
	...
	public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
		return UnusualFishEntities.rollSpawn(UnusualFishConfig.seaMosquitoSpawnRolls, this.getRandom(), spawnReasonIn);
	}
