...
//REMOVE TILT FROM
public class LongjawRockfish extends WaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(LongjawRockfish.class, EntityDataSerializers.BOOLEAN);

	public LongjawRockfish(EntityType<? extends WaterAnimal> entityType, Level level) {
	...
	public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
		return UnusualFishEntities.rollSpawn(UnusualFishConfig.humpbackPogglingSpawnRolls, this.getRandom(), spawnReasonIn);
	}
