...
//REMOVE TILT FROM
public class GrandCorydora extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(GrandCorydora.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public GrandCorydora(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public static AttributeSupplier.Builder createAttributes() {
		return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 5.0D).add(Attributes.ARMOR, 5.0);
	}
	...
	public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
		return UnusualFishEntities.rollSpawn(UnusualFishConfig.mudPigSpawnRolls, this.getRandom(), spawnReasonIn);
	}
