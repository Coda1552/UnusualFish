...
//REMOVE TILT FROM
public class BarkAngelfish extends SchoolingWaterAnimal implements Bucketable {
	private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(BarkAngelfish.class, EntityDataSerializers.BOOLEAN);
	private boolean isSchool = true;

	public BarkAngelfish(EntityType<? extends SchoolingWaterAnimal> entityType, Level level) {
	...
	public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
		return UnusualFishEntities.rollSpawn(UnusualFishConfig.barkAngelSpawnRolls, this.getRandom(), spawnReasonIn);
	}
