...
public class UnusualFishEntities {
	public static final DeferredRegister<EntityType<?>> ENTITIES = DeferredRegister.create(ForgeRegistries.ENTITIES, UnusualFishMod.MOD_ID);
	...
	public static final RegistryObject<EntityType<RhinoTetra>> RHINO_TETRA = ENTITIES.register("rhino_tetra", () -> EntityType.Builder.of(RhinoTetra::new, MobCategory.WATER_CREATURE).sized(0.2f, 0.2f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "rhino_tetra").toString()));
	...
	public static final RegistryObject<EntityType<RedGiantSeaStar>> REDGIANT_SEASTAR = ENTITIES.register("redgiant_seastar", () -> EntityType.Builder.of(RedGiantSeaStar::new, MobCategory.WATER_CREATURE).sized(2.0f, 0.5f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "redgiant_seastar").toString()));
	...
	public static final RegistryObject<EntityType<GrandCorydora>> GRAND_CORY = ENTITIES.register("grand_cory", () -> EntityType.Builder.of(GrandCorydora::new, MobCategory.WATER_AMBIENT).sized(0.5f, 0.5f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "grand_cory").toString()));
	...
	public static final RegistryObject<EntityType<SneepSnorp>> SNEEPSNORP = ENTITIES.register("sneepsnorp", () -> EntityType.Builder.of(SneepSnorp::new, MobCategory.WATER_AMBIENT).sized(0.4f, 0.4f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "sneepsnorp").toString()));
	...
	public static final RegistryObject<EntityType<Slatefish>> SLATEFISH = ENTITIES.register("slatefish", () -> EntityType.Builder.of(Slatefish::new, MobCategory.WATER_AMBIENT).sized(0.7f, 0.4f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "slatefish").toString()));
	...
	public static final RegistryObject<EntityType<LongjawRockfish>> LONGJAW = ENTITIES.register("longjaw", () -> EntityType.Builder.of(LongjawRockfish::new, MobCategory.WATER_AMBIENT).sized(0.5f, 0.4f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "longjaw").toString()));
	public static final RegistryObject<EntityType<Cometfish>> COMET_FISH = ENTITIES.register("comet_fish", () -> EntityType.Builder.of(Cometfish::new, MobCategory.WATER_AMBIENT).sized(0.5f, 0.4f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "comet_fish").toString()));
	public static final RegistryObject<EntityType<Rootball>> ROOTBALL = ENTITIES.register("rootball", () -> EntityType.Builder.of(Rootball::new, MobCategory.MONSTER).sized(0.5f, 0.4f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "rootball").toString()));
	...
	public static final RegistryObject<EntityType<SpoonShark>> SPOON_SHARK = ENTITIES.register("spoon_shark", () -> EntityType.Builder.of(SpoonShark::new, MobCategory.WATER_AMBIENT).sized(1.1f, 0.4f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "spoon_shark").toString()));
	public static final RegistryObject<EntityType<CoralSkrimp>> CORAL_SKRIMP = ENTITIES.register("coral_skrimp", () -> EntityType.Builder.of(CoralSkrimp::new, MobCategory.WATER_AMBIENT).sized(0.5f, 0.4f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "coral_skrimp").toString()));
	public static final RegistryObject<EntityType<CircusFish>> CIRCUSFISH = ENTITIES.register("circus", () -> EntityType.Builder.of(CircusFish::new, MobCategory.WATER_AMBIENT).sized(0.4f, 0.8f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "circus").toString()));
	public static final RegistryObject<EntityType<BlizzardfinTuna>> BLIZZARDFIN = ENTITIES.register("blizzardfin", () -> EntityType.Builder.of(BlizzardfinTuna::new, MobCategory.WATER_AMBIENT).sized(0.8f, 0.8f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "blizzardfin").toString()));
	public static final RegistryObject<EntityType<WhiskeredWhaleShark>> WHISKERED_WHALE_SHARK = ENTITIES.register("whiskered", () -> EntityType.Builder.of(WhiskeredWhaleShark::new, MobCategory.WATER_CREATURE).sized(2.5f, 0.8f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "whiskered").toString()));
	public static final RegistryObject<EntityType<BaskingTiamat>> BASKING_TIAMAT = ENTITIES.register("basking_tiamat", () -> EntityType.Builder.of(BaskingTiamat::new, MobCategory.WATER_CREATURE).sized(5.5f, 0.8f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "basking_tiamat").toString()));
	public static final RegistryObject<EntityType<BaskingTiamatBaby>> BABY_BASKING_TIAMAT = ENTITIES.register("basking_tiamat_baby", () -> EntityType.Builder.of(BaskingTiamatBaby::new, MobCategory.WATER_CREATURE).sized(1.5f, 0.8f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "basking_tiamat_baby").toString()));
	public static final RegistryObject<EntityType<SmelterSnail>> SMELTER_SNAIL = ENTITIES.register("smelter_snail", () -> EntityType.Builder.of(SmelterSnail::new, MobCategory.WATER_CREATURE).sized(2.0f, 2.0f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "smelter_snail").toString()));
	public static final RegistryObject<EntityType<AbyssalBlast>> ABYSSAL_BLAST = ENTITIES.register("abyssal_blast", () -> registerEntity(EntityType.Builder.of(AbyssalBlast::new, MobCategory.MISC).sized(2.0F, 0.2F).setCustomClientFactory(AbyssalBlast::new).fireImmune(), "abyssal_blast"));
	public static final RegistryObject<EntityType<AbyssalShot>> ABYSSAL_SHOT = ENTITIES.register("abyssal_shot", () -> registerEntity(EntityType.Builder.of(AbyssalShot::new, MobCategory.MISC).sized(1.0F, 1.0F).setCustomClientFactory(AbyssalShot::new).fireImmune(), "abyssal_shot"));
	...
	public static final RegistryObject<EntityType<Eyekito>> EYEKITO = ENTITIES.register("eyekito", () -> EntityType.Builder.of(Eyekito::new, MobCategory.WATER_AMBIENT).sized(0.4f, 0.4f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "eyekito").toString()));
	...
	public static final RegistryObject<EntityType<GreenglowLobefin>> GREENGLOW_LOBED_FIN = ENTITIES.register("greenglow", () -> EntityType.Builder.of(GreenglowLobefin::new, MobCategory.WATER_CREATURE).sized(0.6f, 0.6f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "greenglow").toString()));
	...
	public static final RegistryObject<EntityType<Trob>> TROB = ENTITIES.register("trob", () -> EntityType.Builder.of(Trob::new, MobCategory.WATER_CREATURE).sized(1.2f, 0.3f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "trob").toString()));
	public static final RegistryObject<EntityType<Trite>> TRITE = ENTITIES.register("trite", () -> EntityType.Builder.of(Trite::new, MobCategory.WATER_CREATURE).sized(1.7f, 0.4f).build(new ResourceLocation(UnusualFishMod.MOD_ID, "trite").toString()));
