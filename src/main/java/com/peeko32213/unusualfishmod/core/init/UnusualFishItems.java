...
public final class UnusualFishItems {
	...
	public static final RegistryObject<ForgeSpawnEggItem> SMELTER_SNAIL_SPAWN_EGG = ITEMS.register("smelter_snail_spawn_egg", () -> new ForgeSpawnEggItem(UnusualFishEntities.SMELTER_SNAIL, 0x160f10, 0x803837, new Item.Properties().tab(UnusualFishMod.UNUSUAL_TAB)));
