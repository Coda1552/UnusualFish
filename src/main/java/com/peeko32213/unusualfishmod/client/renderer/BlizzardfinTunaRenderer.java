...
import com.peeko32213.unusualfishmod.client.model.BlizzardfinTunaModel;
...
public class BlizzardfinTunaRenderer extends MobRenderer<BlizzardfinTuna, BlizzardfinTunaModel<BlizzardfinTuna>> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation("unusualfishmod:textures/entity/blizzardfintuna.png");

    public BlizzardfinTunaRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new BlizzardfinTunaModel<>(renderManagerIn.bakeLayer(BlizzardfinTunaModel.LAYER_LOCATION)), 0.2F);
    }
