...
import com.peeko32213.unusualfishmod.client.model.SnowflakeTailFishModel;
import com.peeko32213.unusualfishmod.client.model.TigerJungleSharkModel;
...
public class TigerJungleSharkRenderer extends MobRenderer<TigerJungleShark, TigerJungleSharkModel<TigerJungleShark>> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation("unusualfishmod:textures/entity/tigerjungleshark.png");

    public TigerJungleSharkRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new TigerJungleSharkModel<>(renderManagerIn.bakeLayer(TigerJungleSharkModel.LAYER_LOCATION)), 0.2F);
    }
