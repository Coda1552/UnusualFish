...
public class SnowflakeTailFishRenderer extends MobRenderer<SnowflakeTailFish, SnowflakeTailFishModel<SnowflakeTailFish>> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation("unusualfishmod:textures/entity/snowflaketailfish.png");

    public SnowflakeTailFishRenderer(EntityRendererProvider.Context renderManagerIn) {
        super(renderManagerIn, new SnowflakeTailFishModel<>(renderManagerIn.bakeLayer(SnowflakeTailFishModel.LAYER_LOCATION)), 0.2F);
    }
