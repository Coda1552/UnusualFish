...
import com.peeko32213.unusualfishmod.client.model.RipperModel;
import com.peeko32213.unusualfishmod.common.entity.hostile.Ripper;
...
public class RipperRenderer extends MobRenderer<Ripper, RipperModel<Ripper>> {
	protected static final ResourceLocation TEXTURE = new ResourceLocation("unusualfishmod:textures/entity/ripper.png");

	public RipperRenderer(EntityRendererProvider.Context renderManagerIn) {
		super(renderManagerIn, new RipperModel<>(renderManagerIn.bakeLayer(RipperModel.LAYER_LOCATION)), 0.2F);
	}
