...
public class AbyssalBlastRenderer  extends EntityRenderer<AbyssalBlast> {
    private static final ResourceLocation TEXTURE_0 = new ResourceLocation("unusualfishmod:textures/entity/abyssalblast/abyssal_blast_0.png");
    private static final ResourceLocation TEXTURE_1 = new ResourceLocation("unusualfishmod:textures/entity/abyssalblast/abyssal_blast_1.png");
    private static final ResourceLocation TEXTURE_2 = new ResourceLocation("unusualfishmod:textures/entity/abyssalblast/abyssal_blast_2.png");
    private static final ResourceLocation TEXTURE_3 = new ResourceLocation("unusualfishmod:textures/entity/abyssalblast/abyssal_blast_3.png");
