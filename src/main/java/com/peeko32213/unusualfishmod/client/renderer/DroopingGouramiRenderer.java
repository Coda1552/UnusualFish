...
import com.peeko32213.unusualfishmod.client.model.DroopingGouramiModel;
...
public class DroopingGouramiRenderer extends MobRenderer<DroopingGourami, DroopingGouramiModel<DroopingGourami>> {
	protected static final ResourceLocation TEXTURE = new ResourceLocation("unusualfishmod:textures/entity/droopinggourami.png");

	public DroopingGouramiRenderer(EntityRendererProvider.Context renderManagerIn) {
		super(renderManagerIn, new DroopingGouramiModel<>(renderManagerIn.bakeLayer(DroopingGouramiModel.LAYER_LOCATION)), 0.2F);
	}
