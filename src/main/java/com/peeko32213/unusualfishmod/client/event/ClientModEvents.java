...
public final class ClientModEvents { 
	...
	public ClientModEvents() {
		...
		public static void registerLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
			...
			event.registerLayerDefinition(BaskingTiamatBabyModel.LAYER_LOCATION, BaskingTiamatBabyModel::createBodyLayer);
		...
		public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
			...
			event.registerEntityRenderer(UnusualFishEntities.WHISKERED.get(), WhiskeredWhaleSharkRenderer::new);
			...
			event.registerEntityRenderer(UnusualFishEntities.JUNGLE_SHARK.get(), TigerJungleSharkRenderer::new);
